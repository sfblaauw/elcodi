        ...
        $rootNode
            ->children()
                ...
                ->scalarNode('store_tracker')
                    ->isRequired()
                ->end()
                ->arrayNode('store_enabled')
                    ->canBeDisabled()
                    ->children()
                        ->scalarNode('template_path')
                            ->defaultValue(':Pages:store-disabled.html.twig')
                        ->end()
                    ->end()
                ->end()
                ->arrayNode('store_under_construction')
                    ->canBeEnabled()
                    ->children()
                        ->scalarNode('template_path')
                            ->defaultValue(':Pages:store-under-construction.html.twig')
                        ->end()
                    ->end()
                ->end()
